      ...
      $scope.addItem = function(form) {
       ...
       // Werte vom Formular ("Medikament hinzufügen" des add-change-Dialogs) zu Objekten umwandeln
        ...
        newItem.description = form.description.$modelValue ?
            form.description.$modelValue.title: $('input#description_value').val();
        ...
        if (!newItem.bedarf) {
          ...
          if (form.pushNotification.$modelValue == true) {
            ...
            // console.log(form.description.$modelValue.title,
            // 'is scheduled for:', $scope.selectedHours, ':', $scope.selectedMinutes);
            ...
            // Condition welche ausgeführt wird, falls die Notification
            // scheduled ist (true/false)
            // Diese kann mittels Button für Alert zu Testzwecken in der A
            // pp aufgerufen werden. (Funktioniert nicht bei Browser-Tests)
